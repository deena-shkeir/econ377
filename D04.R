...
gta-mean(gta) ##find xbar
miles - mean(miles)  ##find ybar
(gta-mean(gta)) * (miles - mean(miles)) ##multiply pairs
sum((gta-mean(gta)) * (miles - mean(miles)))/(length(gta)-1) ##sum and divide
