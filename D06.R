...
xj <-        # x across pairs (0,0) (0,1) (1,0) (1,1)
yj <-         # y across those same pairs
pj <-       # probability of each pair
EXY <-        # E[XY]                 -- same idea, weight xj*yj
...
##coin example for covariance in class
x = c(0,0,1,1)
y = c(0,1,0,1)
p = c(1/4,1/4,1/4,1/4)
exy = sum(x*y*p)
